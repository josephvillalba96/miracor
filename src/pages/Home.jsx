      ...
      <section className="hero" style={{
        ...
        <div className="container" style={{ 
          ...
          <div className="hero-content" style={{
            ...
            <h1 style={{ 
              fontSize: 'clamp(1.8rem, 6vw, 3.325rem)', 
              fontWeight: '700', 
              marginBottom: '1.5rem',
            ...
            <p style={{ 
              ...
              Suministramos EPP certificados, vestimenta de seguridad y servicios técnicos especializados. 
              Más de 10 años protegiendo vidas en la industria colombiana.
            </p>
            <div className="hero-buttons" style={{ 
              ...
              <a 
                ...
                style={{ 
                  ...
                  boxShadow: '0 4px 15px rgba(57, 67, 183, 0.3)',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '8px'
                }}
                ...
                onMouseOut={(e) => {
                  ...
                  e.target.style.boxShadow = '0 4px 15px rgba(57, 67, 183, 0.3)';
                }}
              >
